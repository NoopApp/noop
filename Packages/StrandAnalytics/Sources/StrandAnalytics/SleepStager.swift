...
public enum SleepStager {
    ...
    /// value can never disagree with what's acted on. Mirrors Android SleepStager. (#78)
    ...
    static func respRateFromRR(_ rr: [RRInterval], start: Int, end: Int) -> Double {
        ...
        // persisted value never silently disagrees with the illness/readiness plausibility gate. (#78)
