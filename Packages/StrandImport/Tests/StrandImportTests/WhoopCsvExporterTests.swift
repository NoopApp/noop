...
/// WhoopExportImporter, assert field-level equality. Mirrors the Android
/// WhoopCsvExporterTest so the exported zip is re-importable by NOOP on either platform.
final class WhoopCsvExporterTests: XCTestCase {
    ...
    func testCyclesRoundTripThroughRealImporter() {
        ...
        // Day attribution survives: cycleStart parsed at UTC+00:00 maps back to 2026-06-01.
        XCTAssertEqual(r.tzOffsetMin, 0)
        XCTAssertEqual(r.cycleStart, Date(timeIntervalSince1970: 1_780_272_000))  // 2026-06-01 00:00:00Z
    }
    ...
    func testZipArchiveRoundTripsThroughFullImporter() throws {
        ...
        let entries: [(name: String, data: Data)] = [
            ...
            // Sidecar + Source column must be ignored by the importer.
