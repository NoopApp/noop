...
object MaverickHaptics {
     ...
     * Wire layout (12-byte body), confirmed against captured frames:
     * ```
     *   [0]      REVISION_1 = 0x01
...
object AlarmPayload {
     ...
     * Returns today's occurrence if strictly in the future, otherwise tomorrow's (the next occurrence
     * strictly after now).
     */
     ...
     * arms its own RTC and fires the wake haptic itself (a strap-driven wake event) even with the
     * phone away. Wire layout, confirmed against captured frames:
     * ```
     *   [0]      0x04 (REVISION_4)
     *   [1]      alarmId
