 ...
 *   - SET_ALARM_TIME rev4 (cmd 66), byte-exact against captured frames
...
class HapticPayloadsTest {
    ...
    fun buzz_singleLoop_matchesOfficialNotificationPattern() {
        // haptic pattern: effects (47,152,0,0,0,0,0,0), loopControl=0, overallLoop=1
    ...
    fun alarm_hapticsTailMatchesOfficialAlarmPattern() {
        // haptic pattern: effects (47,152,0,0,0,0,0,0), loopControl=0, overallLoop=7, duration=30
