...
def _parse_utc(iso: str) -> datetime:
    # fromisoformat (3.11+) handles the trailing "Z" and fractional seconds.
...
def _workout_record(payload: dict) -> str | None:
    ...
    dur = _offset_seconds(payload.get("activeDuration")) or _first_numeric(payload.get("activeDuration"))
    attrs = (
