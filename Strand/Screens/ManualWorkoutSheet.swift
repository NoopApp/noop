...
struct ManualWorkoutSheet: View {
    ...
    var body: some View {
        ...
        // A short 5-field form → open at .medium with .large a drag away; the now-visible grabber
        // also supplies the top dismiss affordance the sheet otherwise lacks (only a bottom Cancel).
